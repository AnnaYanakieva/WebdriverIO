describe("Test the various WebdriverIO Wait Commands", function () {
    beforeEach(function () {
        browser.url("./");
    });
    ...
    //     clickMeButton.waitForExist(100000);
    ...
    //   clickMeButton.waitForEnabled(10000, false); //will check whether the element is enabled and wait for it to turn false (Become Disabled) - will cause the test to fail
