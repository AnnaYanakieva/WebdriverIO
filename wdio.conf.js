...
exports.config = {
     ...
     */
    beforeSession: function (config, capabilities, specs) { //deletes folders
    ...
    before: function (capabilities, specs) {
        ...
        //         $(selector).click();
        //     } catch (Error) {
        //         throw (`Could not click on selector: ${selector}`);
        //     }
        // });
        ...
        //     } catch (Error) {
        //         throw (`Could not send keys: ${keys}, using selector: ${selector}`);
        //     }
        // });
